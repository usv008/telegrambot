<div style="width: 99%;">
    ...
    <div class="w-100" style="width: 98%; margin: 0 auto; text-align: center;">
        ...
        <table class="table table-striped data-table" id="sea_battle_rates_datatable" style="width: 100%;">
            <thead>
            <tr>
                <th class="text-center align-middle" scope="col">ID пользователя</th>
{{--                <th class="text-center align-middle" scope="col">Имя</th>--}}
                <th class="text-center align-middle" scope="col">ID игры</th>
                <th class="text-center align-middle" scope="col">Оценка</th>
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        var table = $("#sea_battle_rates_datatable").DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('sea-battle-rates-list') }}",
            columns: [
